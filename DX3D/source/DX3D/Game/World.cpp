...
dx3_d::World::World(const WorldDesc& desc) : Base(desc.base), m_gameContext(desc.gameContext)
{
}

void dx3_d::World::update(f32 deltaTime)
{
	if (m_events.size())
	{
...
dx3_d::Component* const* dx3_d::World::getComponentsInternal(size_t typeId, ui32* numComponents) const noexcept
{
